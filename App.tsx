            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/20 rounded-xl p-5">
                  ...
                  <a
                    href="/nft-checker"
                    className="block w-full bg-purple-500 hover:bg-purple-600 text-white font-semibold py-2.5 rounded-lg transition-colors text-sm text-center"
                  >
                    开始查询
                  </a>
                </div>
...
function AppContent() {
  return (
    <Routes>
      ...
      <Route path="/nft-checker" element={<NFTChecker />} />
    </Routes>
  );
}
